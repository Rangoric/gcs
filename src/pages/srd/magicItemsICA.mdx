...
<h2 style="margin-top: -40px; margin-bottom: 0px"><span class="subtitle">Intelligent, Cursed, &amp; Artifacts</span>
</h2>
...
<p class="initial">Magic items sometimes have intelligence of
...
<p class="initial">Any item with intelligence has an alignment.
...
<p class="initial">Like a character, an intelligent item speaks
...
<th style="width: 15%">Mental Ability Scores</th>
<th style="width: 15%">Communication</th>
<th style="width: 25%">Capabilities</th>
<th style="width: 25%">Senses</th>
<th style="width: 12%">Base Price Modifier</th>
</tr>
<tr class="odd-row">
<td>01&#8211;34</td>
...
<td class="last-row">Two at 19, one at 10</td>
<td class="last-row">Speech, telepathy<sup>4 5</sup></td>
<td class="last-row">Four lesser powers and three greater
powers<sup>6</sup></td>
<td class="last-row">120 ft. darkvision, blindsense, and
hearing</td>
<td class="last-row">+15,000 gp</td>
</tr>
<tr>
...
<p class="initial">The table above determines how many lesser and
...
<td class="last-row">Item can use cure moderate wounds
(2d8+3) on wielder 3/day</td>
<td class="last-row">+6,500 gp</td>
</tr>
</tbody>
</table>
...
<td class="last-row">Item can use detect thoughts at will</td>
<td class="last-row">+44,000 gp</td>
</tr>
</tbody>
</table>
...
<p class="initial">An item&#8217;s purpose must suit the type and
...
<p class="initial">A dedicated power operates only when an
...
<p class="initial">Ego is a measure of the total power and force
...
<p class="initial">When an item has an Ego of its own, it has a
...
<p class="initial">Cursed items are magic items with some sort of
...
<a id="table-dependent-item-sitauations"></a><table border="0" cellpadding="1" cellspacing="0" style="width: 550px">
<tbody>
<tr>
...
<tr>
<td class="last-row">100</td>
<td class="last-row">More than 100 miles from a particular
site</td>
</tr>
</tbody>
</table>
...
<a id="table-drawbacks"></a><table border="0" cellpadding="1" cellspacing="0" style="width: 100%">
<tbody>
<tr>
...
<p class="initial">Specific Cursed Items are provided as examples
...
<p class="initial">Artifacts are extremely powerful. Rather than
...
<p class="initial">Minor artifacts are not necessarily unique
...
<p class="initial">Described below is a selection of the most
...
is.</p>
<a id="table-book-of-infinite-spells"></a><table border="0" cellpadding="1" cellspacing="0" style="width: 550px">
<tbody>
<tr valign="bottom">
<th>Condition</th>
<th>Chance of
...
<tr>
<td class="last-row">Nonspellcaster employing arcane spell</td>
...
<tbody>
<tr>
<th style="width: 10%">Plaque</th>
<th style="width: 15%">Tarot Card</th>
<th style="width: 15%">Playing Card</th>
<th style="width: 60%">Summary of Effect</th>
</tr>
<tr class="odd-row">
<td>Balance</td>
<td>XI. Justice</td>
...
<tr>
<td class="last-row">The Void</td>
<td class="last-row">Eight of swords</td>
<td class="last-row">King of clubs</td>
<td class="last-row">Body functions, but soul is trapped
elsewhere.</td>
</tr>
</tbody>
</table>
...
<p class="initial">Major artifacts are unique items&#8212;only one of
