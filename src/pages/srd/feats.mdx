...
<p class="initial">Some feats have prerequisites. Your character
...
<p class="initial">Some feats are general, meaning that no
...
<p class="initial">Any feat designated as a fighter feat can be
...
<p class="initial">An item creation feat lets a spellcaster
...
<p class="initial">As a spellcaster&#8217;s knowledge of magic grows,
...
<p class="initial">Here is the format for feat descriptions.</p>
<a id="feat-name-type-of-feat"></a><h5>FEAT NAME [TYPE OF FEAT]</h5>
<a id="feat-prerequisite"></a><p class="initial"><b>Prerequisite</b>: A minimum ability score,
