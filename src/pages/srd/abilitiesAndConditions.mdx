...
If a character&rsquo;s Constitution score drops, then he loses 1 hit
point per Hit Die for every point by which his Constitution
modifier drops. A hit point score can&rsquo;t be reduced by Constitution
...
a portion of its victim&rsquo;s life force from her. Most energy drain
attacks require a successful melee attack roll &mdash; mere physical
...
sound. (An ethereal creature can&rsquo;t see through a material wall,
for instance.) An ethereal creature inside an object on the
Material Plane cannot see. Things on the Material Plane, however,
look gray, indistinct, and ghostly. An ethereal creature can&rsquo;t
...
At the beginning of each of the creature&rsquo;s turns, it heals a
certain number of hit points (defined in its description).
</p>
<p>
...
Otherwise, it melds with the new form and ceases to function for
the duration of the polymorph.
</p>
<h5><a id="psionics"></a>
PSIONICS
</h5>
...
decreases depending on how strong the quarry&rsquo;s odor is, the number
...
Only spells and spell-like abilities are subject to spell
...
Spell resistance can protect a creature from a spell that&rsquo;s
...
attacker&rsquo;s spell resistance &mdash; it is the protected creature that is
...
a magical effect from another creature or negates a spell&rsquo;s effect
on another creature. Spell resistance prevents a spell from
disrupting another spell.
</p>
<p>
...
Some creatures (usually undead) are less easily affected by the
turning ability of clerics or paladins.
</p>
<p>
...
falls to the ground and is <a href="abilitiesAndConditions.html#helpless"
style="color: rgb(87, 158, 182);">helpless</a>. A character with
Dexterity 0 is <a href="abilitiesAndConditions.html#paralyzed"
style="color: rgb(87, 158, 182);">paralyzed</a>. A character with
Constitution 0 is <a href="abilitiesAndConditions.html#dead"
style="color: rgb(87, 158, 182);">dead</a>. A character with
Intelligence, Wisdom, or Charisma 0 is <a style="
color: rgb(87, 158, 182);" href="abilitiesAndConditions.html#unconscious">unconscious</a>. Ability
damage is different from penalties to ability scores, which go
away when the conditions causing them go away.

Also see <a href="#ability-score-loss" style="
color: rgb(87, 158, 182);">Ability Score Loss</a>.
...
<a href="#helpless" style="color: rgb(87, 158, 182);">helpless</a>. A
character with Dexterity 0 is <a href="#paralyzed" style="
color: rgb(87, 158, 182);">paralyzed</a>. A character with
Constitution 0 is <a href="#dead" style="
color: rgb(87, 158, 182);">dead</a>. A character with
Intelligence, Wisdom, or Charisma 0 is <a href="#unconscious"
style="color: rgb(87, 158, 182);">unconscious</a>.
...
color: rgb(87, 158, 182);">Search</a> checks and on most
...
color: rgb(87, 158, 182);">knocked down</a> and rolls 1d4 x 10
...
<a href="skillsAll.html#search" style="
color: rgb(87, 158, 182);">Search</a> checks, and
<a href="skillsAll.html#spot" style="color: rgb(87, 158, 182);">Spot</a>
checks.
</p>
<p>
...
color: rgb(87, 158, 182);">Listen</a> checks, and has a 20%
...
<a href="#stable" style="color: rgb(87, 158, 182);">stable</a> and
...
<a href="#unconscious" style="color: rgb(87, 158, 182);">unconscious</a>
...
Alos see <a href="#energy-drain" style="
color: rgb(87, 158, 182);">Energy Drain and Negative
Levels</a>.
...
color: rgb(87, 158, 182);">charge</a>, and takes a &#8211;2 penalty on
...
color: rgb(87, 158, 182);">Concentration</a> check (DC 15 + the
...
color: rgb(87, 158, 182);">fatigued</a>. A fatigued character
...
color: rgb(87, 158, 182);">Listen</a> and
<a href="skillsAll.html#spot" style="color: rgb(87, 158, 182);">Spot</a>
...
Frightened is like <a href="#shaken" style="
color: rgb(87, 158, 182);">shaken</a>, except that the creature
must flee if possible. <a href="#panicked" style="
color: rgb(87, 158, 182);">Panicked</a> is a more extreme state
of fear.
</p>
<p>
...
Also see the <a href="specialAttacks.html#grapple" style="
color: rgb(87, 158, 182);">grapple</a> rules.

</p>
<p>
<b><a id="helpless"></a>Helpless</b>: A helpless character is
<a href="#paralyzed" style="
color: rgb(87, 158, 182);">paralyzed</a>, held, bound, sleeping,
<a href="#unconscious" style="
color: rgb(87, 158, 182);">unconscious</a>, or otherwise
...
<a href="#prone" style="color: rgb(87, 158, 182);">prone</a> target).
...
Also see <a href="#incorporeality" style="
color: rgb(87, 158, 182);">Incorporeality</a>.
...
color: rgb(87, 158, 182);">Invisibility</a>, under Special
Abilities.)
</p>
...
color: rgb(87, 158, 182);">prone</a> by the force of the wind.
...
<a href="#cowering" style="color: rgb(87, 158, 182);">cowers</a> and does
...
Panicked is a more extreme state of fear than <a href="#shaken"
style="color: rgb(87, 158, 182);">shaken</a> or
<a href="#frightened" style="color: rgb(87, 158, 182);">frightened</a>.
</p>
<p>
...
<a href="#helpless" style="color: rgb(87, 158, 182);">helpless</a>, but
...
color: rgb(87, 158, 182);" href="#unconscious">unconscious</a>.
...
color: rgb(87, 158, 182);">helpless</a>) in a
<a href="specialAttacks.html#grapple" style="
color: rgb(87, 158, 182);">grapple</a>.
</p>
...
Shaken is a less severe state of fear than <a href="#frightened"
style="color: rgb(87, 158, 182);">frightened</a> or
<a href="#panicked" style="color: rgb(87, 158, 182);">panicked</a>.
</p>
...
<a href="#dying" style="color: rgb(87, 158, 182);">dying</a> but who has
...
color: rgb(87, 158, 182);">Heal</a> check or magical healing),
...
color: rgb(87, 158, 182);">disabled</a> (even though his hit
...
<a href="#helpless" style="
color: rgb(87, 158, 182);">helpless</a>. Unconsciousness can
