...
<a id="table-skill-synergies"></a><p><span style="font-weight: bold;">Table: Skill Synergies

</span></p>
<table border="0" cellpadding="1" cellspacing="0">
<tbody>
<tr>
<th style="width: 170px;">5
or more ranks in. . .</th>
<th>Gives a +2 bonus
on. . .</th>
</tr>
...
<p><span style="font-weight: bold;">Check:</span>
The DC and the
effect of a successful check depend on the task you attempt.</p>
<table border="0" cellpadding="1" cellspacing="0">
<tbody>
<tr>
<th style="width: 300px">Task 

</th>
<th style="width: 200px">DC</th>
</tr>
<tr class="odd-row">
<td>Ignore caltrop
wound
...
<a id="ignore-caltrop-wound"></a><p><span style="font-style: italic;">Ignore Caltrop Wound:</span>
...
through
self-persuasion.</p>
<a id="memorize"></a><p><span style="font-style: italic;">Memorize:</span>
You can
...
<a id="resist-dying"></a><p><span style="font-style: italic;">Resist Dying:</span>
You can
attempt to subconsciously prevent yourself from <a
href="abilitiesAndConditions.html#dying"
style="color: rgb(87, 158, 182);">dying</a>.
If you have
...
to see if you become <a href="abilitiesAndConditions.html#stable"
style="color: rgb(87, 158, 182);">stable</a>.
If the check is
successful, you stop
...
<a id="resist-fear"></a><p><span style="font-style: italic;">Resist Fear:</span>
In
...
<a id="tolerate-poison"></a><p><span style="font-style: italic;">Tolerate Poison:</span>
You
...
<a id="willpower"></a><p><span style="font-style: italic;">Willpower:</span>
If reduced
to 0 hit points (<a href="abilitiesAndConditions.html#disabled"
style="color: rgb(87, 158, 182);">disabled</a>),
you can make an
...
<p><span style="font-weight: bold;">Action:</span>
None. Making
...
<p><span style="font-weight: bold;">Try Again:</span>
Yes, for
memorize and willpower uses, though a success doesn&rsquo;t cancel
the
effects of a previous failure. No for the other uses.</p>
<p><span style="font-weight: bold;">Synergy:</span>
If you have 5
or more ranks in Autohypnosis, you get a +2 bonus on <a
href="#knowledge-psionics" style="color: rgb(87, 158, 182);">Knowledge
(psionics)</a> checks.</p>
...
<p>The following are
additional uses for the <a href="skillsAll.html#concentration"
...
style="color: rgb(87, 158, 182);">Entangled</a>.
...
style="color: rgb(87, 158, 182);">Grappling</a>
or <a href="abilitiesAndConditions.html#pinned"
style="color: rgb(87, 158, 182);">pinned</a>.
...
<tr>
<td colspan="2">1 <span style="font-style: italic;">If
you
...
<tr>
<td colspan="2">2 <span style="font-style: italic;">Such
...
<tr>
<td colspan="2">3 <span style="font-style: italic;">Such
as from standing in natural fire or lava.</span>

</td>
</tr>
<tr>
<td colspan="2">4 <span style="font-style: italic;">If
the
...
<a id="gain-psionic-focus"></a><p><span style="font-style: italic;">Gain Psionic Focus:</span>
...
as if you rolled a 15. It&rsquo;s like taking 10, except that the
number you
...
<p>A character with the <a
href="psionicFeats.html#combat-manifestation"
style="color: rgb(87, 158, 182);">Combat Manifestation</a>
feat gets a
+4 bonus
...
<p><span style="font-weight: bold;">Synergy:</span>
If you have 5
or more ranks in Concentration, you get a +2 bonus on <a
href="#autohypnosis" style="color: rgb(87, 158, 182);">Autohypnosis</a>
checks.

</p>
<h5><a id="knowledge-psionics"></a>KNOWLEDGE
(PSIONICS) (INT)</h5>
Like the <a href="skillsAll.html#craft"
style="color: rgb(87, 158, 182);">Craft</a>
and <a href="skillsAll.html#profession"
style="color: rgb(87, 158, 182);">Profession</a>
skills, <a href="skillsAll.html#knowledge"
...
<p><span style="font-weight: bold;">Synergy:</span>
If you have 5
or more ranks in Knowledge (psionics), you get a +2 bonus on <a
href="#psicraft" style="color: rgb(87, 158, 182);">Psicraft</a>
checks.</p>
<p>If you have 5 or more
ranks in <a href="#autohypnosis" style="color: rgb(87, 158, 182);">Autohypnosis</a>,
you get a +2
bonus on Knowledge (psionics) checks.</p>
<p><span style="font-weight: bold;">Untrained:</span>
An
...
his discipline.</p>
<p>If you have the <a href="psionicFeats.html#psionic-affinity"
style="color: rgb(87, 158, 182);">Psionic Affinity</a>
feat, you get a
+2 bonus on
Psicraft checks.</p>
<p><span style="font-weight: bold;">Synergy:</span>
If you have 5
or more ranks in Psicraft, you get a +2 bonus on <a
href="#use-psionic-device" style="color: rgb(87, 158, 182);">Use
Psionic Device</a>
...
<td style="text-align: left;">Activate
blindly</td>
</tr>
<tr>
<td>25 + power level</td>
...
<tr class="odd-row">
<td>See text</td>
<td style="text-align: left;">Emulate
an ability score</td>
</tr>
<tr>
<td>30
...
<tr>
<td class="last-row">20
+ manifester level</td>
<td class="last-row" style="text-align: left;">Use a power
stone</td>
</tr>
</tbody>
</table>
<p><span style="font-style: italic;">Activate Blindly:</span>
...
manifesting a power from a power stone.</p>
<a id="address-a-power-stone"></a><p><span style="font-style: italic;">Address a Power Stone:</span>
...
<a id="emulate-an-ability-score"></a><p><span style="font-style: italic;">Emulate an Ability Score:</span>
...
make
this check.</p>
<a id="emulate-an-alignment"></a><p><span style="font-style: italic;">Emulate an Alignment:</span>
...
time. </p>
<p><span style="font-style: italic;">Emulate a Class Feature:</span>
...
appropriate alignment as a separate check (see above).</p>
<a id="emulate-a-race"></a><p><span style="font-style: italic;">Emulate a Race:</span>
Some
...
<a id="use-a-dorje"></a><p><span style="font-style: italic;">Use a Dorje:</span>
...
<a id="use-a-power-stone"></a><p><span style="font-style: italic;">Use a Power Stone:</span>
...
<p>A character with the <a
href="psionicFeats.html#psionic-affinity"
style="color: rgb(87, 158, 182);">Psionic Affinity</a>
feat gets a +2
bonus on
...
<p><span style="font-weight: bold;">Synergy:</span>
If you have 5
or more ranks in <a href="#psicraft" style="color: rgb(87, 158, 182);">Psicraft</a>,
