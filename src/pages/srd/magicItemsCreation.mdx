...
<h2 style="margin-top: -40px; margin-bottom: 0px"><span class="subtitle">Creating Magic Items</span>
</h2>
...
<th colspan="2" class="center">Spell Component Costs</th>
<th colspan="2">
...
<tr>
<td class="last-row">Wondrous Item</td>
<td class="last-row">Craft Wondrous Item</td>
<td class="last-row"><sup>5</sup></td>
<td class="last-row">x 50 (usually none)</td>
<td class="last-row">x 50 (usually none) x 5 gp</td>
<td class="last-row">Special, see Table: Estimating Magic
...
<p class="initial">Many factors must be considered when
...
<p class="initial">Masterwork items are extraordinarily well-made
...
<p class="initial">To create magic armor, a character needs a
...
<p class="initial">To create a magic weapon, a character needs a
...
<p class="initial">The creator of a potion needs a level working
...
<table border="0" cellpadding="1" cellspacing="0" style="width: 575px">
<tbody>
<tr>
<th style="width: 20%">Spell Level</th>
<th style="width: 20%">Clr, Drd, Wiz</th>
<th style="width: 20%">Sor</th>
<th style="width: 20%">Brd</th>
<th style="width: 20%">Pal, Rgr*</th>
</tr>
<tr class="odd-row">
<td>0</td>
<td>25 gp</td>
...
<td class="last-row">750 gp</td>
<td class="last-row">900 gp</td>
<td class="last-row">1,050 gp</td>
<td class="last-row">750 gp</td>
</tr>
<tr>
...
<tr>
<td class="last-row">3rd</td>
<td class="last-row">375 gp
+30 XP</td>
<td class="last-row">450 gp
+36 XP</td>
<td class="last-row">525 gp
+42 XP</td>
<td class="last-row">375 gp
+30 XP</td>
</tr>
...
<p class="initial">To create a magic ring, a character needs a
...
<p class="initial">To create a magic rod, a character needs a
...
<p class="initial">To create a scroll, a character needs a supply
...
<td class="last-row">3,825 gp</td>
<td class="last-row">4,050 gp</td>
...
<tr>
<td class="last-row">9th</td>
<td class="last-row">1,912 gp 5 sp
+ 153 XP</td>
<td class="last-row">2, 025 gp
+162 XP</td>
<td class="last-row">&#8212;</td>
<td class="last-row">&#8212;</td>
</tr>
...
<p class="initial">To create a magic staff, a character needs a
...
<p class="initial">To create a magic wand, a character needs a
...
<p class="initial">To create a wondrous item, a character usually
...
<p class="initial">To create an intelligent item, a character
...
<p class="initial">A creator can add new magical abilities to a
...
<p class="initial">Each location on the body, or body slot, has
...
specific items. </p>
<a id="table-body-slot-affinities"></a><table border="0" cellpadding="1" cellspacing="0" style="width: 575px">
<tbody>
<tr>
<th>Body Slot</th>
<th>Affinity</th>
