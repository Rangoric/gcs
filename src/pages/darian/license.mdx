...
trademark), Forgotten Realms, Faer&ucirc;n, character names (including
...
Book of Vile Darkness, beholder, gauth, carrion crawler, tanar&rsquo;ri,
baatezu, displacer beast, githyanki, githzerai, mind flayer, illithid,
umber hulk, yuan-ti.

All of the rest of the SRD is Open Game Content as described
in Section 1(d) of the License.

More information on the Open Game License can be found at [www.opengamingfoundation.org](http://www.opengamingfoundation.org)
or [www.wizards.com/d20](http://www.wizards.com).
...
Jensen.
  - Generic Character Sheet 2020, Wilson Gearld Mead
